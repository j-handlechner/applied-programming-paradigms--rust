...
export class GameOfLife {
    ...
    constructor(width, height, cell_size) {
        const ret = wasm.gameoflife_new(width, height, cell_size);
        this.__wbg_ptr = ret >>> 0;
        GameOfLifeFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    reset_cells() {
        wasm.gameoflife_reset_cells(this.__wbg_ptr);
    }
    /**
     * @param {number} iteration
     * @param {HTMLCanvasElement} canvas
     */
    life(iteration, canvas) {
        wasm.gameoflife_life(this.__wbg_ptr, iteration, canvas);
    }
    /**
     * @param {HTMLCanvasElement} canvas
     */
    append_life_iteration(canvas) {
        wasm.gameoflife_append_life_iteration(this.__wbg_ptr, canvas);
    }
}

const GameOfLifeCellFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_gameoflifecell_free(ptr >>> 0, 1));
...
export class GameOfLifeCell {
    ...
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        GameOfLifeCellFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_gameoflifecell_free(ptr, 0);
    }
}
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_rect_17626d88e7f27071 = function(arg0, arg1, arg2, arg3, arg4) {
